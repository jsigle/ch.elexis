...
public abstract class AbstractProperties extends Properties {
	 ...
	 * <code>'&#92;u0020'</code>), tab (<code>'\t'</code>, <code>'&#92;u0009'</code>), and form feed (<code>'\f'</code>, <code>'&#92;u000C'</code>) to be
	 * white space.
	 * 
	 * <p>
	 ...
	 * string the sequence <code>"\z"</code> would cause a compile time error. In contrast, this method
	 * silently drops the backslash. Therefore, this method treats the two character sequence
