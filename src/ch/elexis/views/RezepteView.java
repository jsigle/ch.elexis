 ...
 * 
 *  $Id: RezepteView.java 6134 2010-02-13 09:51:29Z rgw_ch $
 *******************************************************************************/
...
public class RezepteView extends ViewPart implements IActivationListener, ISaveablePart2 {
	...
	public void createPartControl(final Composite parent){
		...
		for (IAction ac : importers) {
			...
			/*
			 * 201201260313js
			 * At any time, the size of the first icon in the toolbar determines the size
			 * used to display any icon in the toolbar. So if that icon is too small,
			 * it may be helpful to see the name of the responsible plugin, to guide
			 * problem solving.
			 * The following line shows the names of extensions to the toolbar in the console output: 
			 */
			//System.out.print("jsdebug: RezepteView.java ToolbarAction: "+ac.toString()+"\n");
